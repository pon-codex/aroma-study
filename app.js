const freeOils=[{"name":"スイートオレンジ","latin":"Citrus sinensis","cat":"柑橘系","scent":"甘くジューシー","note":"トップノート","key":"リモネン","effect":"心：緊張やイライラをゆるめ、明るい気分へ。｜身体：食欲がないときや休息前のリラックスに。｜暮らし：寝室や家族で過ごす空間の芳香に。","aroma":"もぎたての果皮をむいたときのような、甘く親しみやすい柑橘の香り。","bodyConcern":"食欲低下・緊張で眠りにくい・胃の重さ｜ストレスで食欲や休息のリズムが乱れたときの芳香浴に。","extraction":"圧搾法","family":"ミカン科","imageIndex":0},{"name":"ゼラニウム","latin":"Pelargonium graveolens","cat":"フローラル","scent":"ローズ調で甘い","note":"ミドルノート","key":"シトロネロール","effect":"心：気分の波を穏やかに整えたいときに。｜身体：月経前後など心身が揺らぎやすい時期の芳香に。｜美容：皮脂バランスを整えるスキンケアで親しまれる。","aroma":"ローズに青葉とほのかなミントを重ねたような、甘く爽やかな香り。","bodyConcern":"月経前の重だるさ・むくみ感・緊張性の頭重感｜女性の周期に伴う気分や身体の揺らぎ、脚の重さを感じる日の芳香やトリートメントに。","extraction":"水蒸気蒸留法","family":"フウロソウ科","imageIndex":1},{"name":"ティートリー","latin":"Melaleuca alternifolia","cat":"樹木・樹脂","scent":"清潔感のある","note":"トップノート","key":"テルピネン-4-オール","effect":"心：疲れた気分をしゃきっと切り替える。｜身体：季節の変わり目のすっきりした芳香に。｜暮らし：清潔感のあるルームスプレーに向く。","aroma":"清潔感のある鋭い葉の香りに、少し薬草や土を思わせる力強さ。","bodyConcern":"季節の変わり目の鼻・のどの不快感、肌を清潔に保ちたいとき｜空間芳香や希釈した部分的なスキンケアで親しまれる。","extraction":"水蒸気蒸留法","family":"フトモモ科","imageIndex":2},{"name":"フランキンセンス","latin":"Boswellia carterii","cat":"樹木・樹脂","scent":"深く神聖な樹脂調","note":"ベースノート","key":"α-ピネン","effect":"心：不安や焦りを鎮め、深く落ち着きたいときに。｜身体：ゆっくりした呼吸や瞑想のお供に。｜美容：乾燥・年齢肌のケアで親しまれる。","aroma":"澄んだレモン調の軽さと、静かな木・樹脂の深みを併せ持つ香り。","bodyConcern":"浅い呼吸・緊張・乾燥肌｜胸が詰まるように感じるときのゆっくりした呼吸や、乾燥する季節のスキンケアに。","extraction":"水蒸気蒸留法","family":"カンラン科","imageIndex":3},{"name":"ペパーミント","latin":"Mentha × piperita","cat":"ハーブ","scent":"鋭く清涼感のある","note":"トップノート","key":"メントール","effect":"心：眠気を払い、集中したいときの気分転換に。｜身体：暑さや乗り物移動時の不快感を爽やかにする芳香に。｜注意：刺激が強いため少量から使用する。","aroma":"ミントガムを思わせる強い清涼感と、鼻に抜ける鋭く冷たい香り。","bodyConcern":"眠気・吐き気や乗り物酔いの不快感・緊張型の頭重感・暑さ｜短時間の芳香で気分をすっきりさせたいときに。乳幼児の顔周辺には使わない。","extraction":"水蒸気蒸留法","family":"シソ科","imageIndex":4},{"name":"ユーカリ","latin":"Eucalyptus globulus","cat":"樹木・樹脂","scent":"クリアで鋭い","note":"トップノート","key":"1,8-シネオール","effect":"心：頭をクリアにして作業へ切り替えたいときに。｜身体：鼻やのどをすっきり感じたい季節の芳香に。｜注意：刺激を感じやすい人や乳幼児の周囲では慎重に。","aroma":"森林の葉を揉んだような、シャープで透明感のあるカンファー調の香り。","bodyConcern":"鼻づまり感・のどの不快感・頭がぼんやりする感じ｜季節性の不快感があるときの短時間の芳香に。呼吸器症状が強い場合は受診する。","extraction":"水蒸気蒸留法","family":"フトモモ科","imageIndex":5},{"name":"ラベンダー","latin":"Lavandula angustifolia","cat":"フローラル","scent":"やさしくハーバル","note":"ミドルノート","key":"酢酸リナリル","effect":"心：緊張をほどき、穏やかな休息へ導く。｜身体：就寝前や疲れた日のリラックスタイムに。｜美容：肌を健やかに保つケアで広く親しまれる。","aroma":"やわらかな花の甘さに、草原を思わせるハーブの爽やかさが重なる香り。","bodyConcern":"寝つきの悪さ・緊張性の頭重感・肩のこわばり・軽い肌荒れ｜休息前の芳香、温湿布、希釈したスキンケアで広く用いられる。","extraction":"水蒸気蒸留法","family":"シソ科","imageIndex":6},{"name":"レモン","latin":"Citrus limon","cat":"柑橘系","scent":"フレッシュで明るい","note":"トップノート","key":"リモネン","effect":"心：集中力を保ち、頭をすっきりさせたいときに。｜暮らし：勉強部屋や掃除後の空間芳香に。｜注意：圧搾法の精油は肌への使用後、紫外線を避ける。","aroma":"果皮を搾った瞬間のような、酸味を感じる明るくキリッとした香り。","bodyConcern":"眠気・集中力低下・食欲低下・室内のこもった不快感｜朝や勉強中の芳香に。皮膚使用後の紫外線に注意する。","extraction":"圧搾法","family":"ミカン科","imageIndex":7},{"name":"ローズ（アブソリュート）","latin":"Rosa centifolia","cat":"フローラル","scent":"濃厚で甘い花","note":"ミドルノート","key":"フェニルエチルアルコール","effect":"心：悲しみや自信を失ったとき、気持ちをやさしく包む芳香に。｜美容：乾燥肌のぜいたくなケアに。｜特徴：溶剤抽出法で得る、濃厚で華やかな香り。","aroma":"蜜のような甘さと深みがある、重厚で濃密な生花のバラの香り。","bodyConcern":"月経前後の不快感・緊張・乾燥肌｜周期に伴う気分の落ち込みや、乾燥が気になるときの低濃度ケアに。","extraction":"揮発性有機溶剤抽出法","family":"バラ科","imageIndex":8},{"name":"ローズオットー","latin":"Rosa damascena","cat":"フローラル","scent":"上品で繊細な花","note":"ミドルノート","key":"シトロネロール","effect":"心：心を落ち着かせ、幸福感や自信を取り戻したいときに。｜美容：乾燥・年齢肌のケアで親しまれる。｜特徴：水蒸気蒸留法で得られ、低温で固まることがある。","aroma":"朝露をまとったバラのような、みずみずしく上品で繊細な香り。","bodyConcern":"月経前後の不快感・更年期の揺らぎ・乾燥肌｜女性のライフステージに伴う緊張や乾燥をいたわる芳香・スキンケアに。","extraction":"水蒸気蒸留法","family":"バラ科","imageIndex":9}];
const premiumTeasers=[{"name":"ローズマリー","latin":"Rosmarinus officinalis","cat":"ハーブ","imageIndex":10,"locked":true},{"name":"イランイラン","latin":"Cananga odorata","cat":"フローラル","imageIndex":11,"locked":true},{"name":"クラリセージ","latin":"Salvia sclarea","cat":"ハーブ","imageIndex":12,"locked":true},{"name":"グレープフルーツ","latin":"Citrus paradisi","cat":"柑橘系","imageIndex":13,"locked":true},{"name":"サイプレス","latin":"Cupressus sempervirens","cat":"樹木・樹脂","imageIndex":14,"locked":true},{"name":"サンダルウッド","latin":"Santalum album","cat":"樹木・樹脂","imageIndex":15,"locked":true},{"name":"ジャーマンカモミール","latin":"Matricaria chamomilla","cat":"フローラル","imageIndex":16,"locked":true},{"name":"ジャスミン（アブソリュート）","latin":"Jasminum grandiflorum","cat":"フローラル","imageIndex":17,"locked":true},{"name":"ジュニパーベリー","latin":"Juniperus communis","cat":"樹木・樹脂","imageIndex":18,"locked":true},{"name":"スイートマージョラム","latin":"Origanum majorana","cat":"ハーブ","imageIndex":19,"locked":true},{"name":"ネロリ","latin":"Citrus aurantium","cat":"フローラル","imageIndex":20,"locked":true},{"name":"パチュリ","latin":"Pogostemon cablin","cat":"樹木・樹脂","imageIndex":21,"locked":true},{"name":"ブラックペッパー","latin":"Piper nigrum","cat":"ハーブ","imageIndex":22,"locked":true},{"name":"ベチバー","latin":"Vetiveria zizanioides","cat":"樹木・樹脂","imageIndex":23,"locked":true},{"name":"ベルガモット","latin":"Citrus bergamia","cat":"柑橘系","imageIndex":24,"locked":true},{"name":"ベンゾイン（レジノイド）","latin":"Styrax benzoin","cat":"樹木・樹脂","imageIndex":25,"locked":true},{"name":"ミルラ","latin":"Commiphora myrrha","cat":"樹木・樹脂","imageIndex":26,"locked":true},{"name":"メリッサ","latin":"Melissa officinalis","cat":"ハーブ","imageIndex":27,"locked":true},{"name":"レモングラス","latin":"Cymbopogon citratus","cat":"ハーブ","imageIndex":28,"locked":true},{"name":"ローマンカモミール","latin":"Chamaemelum nobile","cat":"フローラル","imageIndex":29,"locked":true}];
...
let accessPlan='free',paymentsConfigured=false,premiumOils=[],filter='すべて',query='',flipped=new Set(),scrollTopThreshold=Infinity,scrollAnimationFrame=0;
...
function showInstallHint(){
 ...
 if(standalone||(!ios&&!android)||sessionStorage.getItem('installHintDismissed'))return;
...
function scrollToTopWithEase(){
 cancelAnimationFrame(scrollAnimationFrame);const start=window.scrollY;
 if(!start||matchMedia('(prefers-reduced-motion: reduce)').matches){window.scrollTo(0,0);return}
 const duration=Math.min(1100,Math.max(650,start/3)),started=performance.now();
 const step=now=>{const progress=Math.min(1,(now-started)/duration),eased=1-Math.pow(1-progress,4);window.scrollTo(0,Math.round(start*(1-eased)));if(progress<1)scrollAnimationFrame=requestAnimationFrame(step)};
